 ...
 *      #pragma pack(4)
struct wifi_msg_dfu_reset_cmd_t
 *      {
 *          uint8	dfu;
 *      }
 *
...
#define #pragma pack(4)
 decl ) decl __attribute__((__packed__,gcc_struct))
#else
#define #pragma pack(4)
 decl ) decl __attribute__((__packed__))
#endif
...
#define #pragma pack(4)
 decl ) __pragma( pack(push, 1) ) decl __pragma( pack(pop) )
#define ALIGNED
#else 
#define #pragma pack(4)
a) a PACKED 
...
#pragma pack(4)
struct ble_msg_system_aes_encrypt_cmd_t
{
	uint8array	data;
};
...
#pragma pack(4)
struct ble_msg_system_aes_decrypt_cmd_t
{
	uint8array	data;
};
...
#pragma pack(4)
struct ble_msg_attributes_send_cmd_t
{
	uint8	connection;
	uint16	handle;
	uint8array	value;
...
#pragma pack(4)
struct ble_msg_connection_slave_latency_disable_cmd_t
{
	uint8	disable;
};

#pragma pack(4)
struct ble_msg_connection_slave_latency_disable_rsp_t
{
	uint16	result;
};
...
#pragma pack(4)
struct ble_msg_gap_set_initiating_con_parameters_cmd_t
{
	uint16	scan_interval;
	uint16	scan_window;
};
...
#pragma pack(4)
struct ble_msg_gap_set_initiating_con_parameters_rsp_t
{
	uint16	result;
};
...
#pragma pack(4)
struct ble_msg_hardware_analog_comparator_enable_cmd_t
{
	uint8	enable;
};
...
#pragma pack(4)
struct ble_msg_hardware_analog_comparator_config_irq_cmd_t
{
	uint8	enabled;
};
...
#pragma pack(4)
struct ble_msg_hardware_set_rxgain_cmd_t
{
	uint8	gain;
};

#pragma pack(4)
struct ble_msg_hardware_usb_enable_cmd_t
{
	uint8	enable;
};
